package dsa;
	...
	int quantity;
	double price;
	public GroceryBill(int pid, String name, int quantity, double price) {
		this.pid = pid;
		this.name = name;
	...
	ArrayList<GroceryBill>al = new ArrayList<GroceryBill>();
	...
	do {
		...
		case 1:
			for(int i=0;i<n;i++) {
				...
				GroceryBill g = new GroceryBill(pid, name, quantity, price);
				al.add(g);
